...
describe Screen do
  ...
  context 'getting all view elements' do
    it 'can get a list of all the buttons on the screen' do
      screen.button_labels.should == ["buttonLabel1", "buttonLabel2"]
    end
  end
end